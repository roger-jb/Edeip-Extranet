...
public class CarnetLiaisonDetailFragment extends Fragment {
     ...
     */
    private DummyContentLiaison.DummyItem mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = DummyContentLiaison.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.carnetliaison_detail)).setText(mItem.details);
        }
